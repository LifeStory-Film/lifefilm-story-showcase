...
const INSTAGRAM_POSTS: InstagramPost[] = [
  {
    id: '1',
    image: 'https://d397bfy4gvgcdm.cloudfront.net/427000-Karthi_Portrait-46.jpeg',
    caption: 'Traditional elegance meets modern cinematography ✨',
    likes: 487,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    id: '2',
    image: 'https://d397bfy4gvgcdm.cloudfront.net/431045-0447-NV-Embarcadero-San-Diego-Wedding-Photography.jpeg',
    caption: 'Every detail tells a story of love and radiance 🌹',
    likes: 542,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    id: '3',
    image: 'https://media-api.xogrp.com/images/b6e57689-0c06-4529-b6aa-f955fa314907~rs_768.h',
    caption: 'Timeless beauty in traditional bridal portraiture 👑',
    likes: 629,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    id: '4',
    image: 'https://www.teribphotography.com/wp-content/uploads/2022/11/indian-wedding-photography-33-scaled.jpg',
    caption: 'Art in motion - henna stories and wedding magic ✋',
    likes: 734,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    id: '5',
    image: 'https://d397bfy4gvgcdm.cloudfront.net/327768-0099-Reema-Rahim-Reception20210327.jpeg',
    caption: 'Luxury meets timeless romance in every frame 🎬',
    likes: 618,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    id: '6',
    image: 'https://d397bfy4gvgcdm.cloudfront.net/431199-Dhruv-Allison-Sangeet-119.jpeg',
    caption: 'Cultural traditions captured with artistic vision 🎭',
    likes: 425,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    ...
    caption: 'Intimate moments captured with cinematic perfection 💕',
    likes: 329,
    url: 'https://instagram.com/lifestoryfilm'
  },
  {
    ...
    caption: 'Every frame tells a unique love story 📸',
    likes: 568,
    url: 'https://instagram.com/lifestoryfilm'
  }
]
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
            ...
            {TESTIMONIALS.map((testimonial) => (
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <div className="w-20 h-20 rounded-full overflow-hidden mb-4 border-2 border-[#BFA181]/30">
                    <OptimizedImage
          ...
          <div className="text-center">
            ...
            <p className="text-primary/80 mb-8">@lifestory.film</p>
              ...
              >
                {INSTAGRAM_POSTS.map((post) => (
                  <div key={post.id} className="w-1/4 flex-shrink-0 p-2">
                    <div className="relative group cursor-pointer border-2 border-[#BFA181]/20 rounded-lg overflow-hidden hover:border-[#BFA181]/60 transition-colors duration-300">
                      <OptimizedImage
                        src={post.image}
                        alt={post.caption}
