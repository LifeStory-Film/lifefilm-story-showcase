...
const SLIDER_IMAGES: SlideImage[] = [
  {
    ...
    alt: 'Traditional South Asian Bridal Portrait',
  ...
  },
  {
    ...
    alt: 'Couple in Traditional Attire Against Sky',
  ...
  },
  {
    ...
    alt: 'Luxury Wedding Portrait in Elegant Setting',
  ...
  },
  {
    ...
    alt: 'Artistic Henna Bridal Photography',
    title: 'Art in Motion',
  ...
  },
  {
    ...
    alt: 'Vibrant Traditional Wedding in Garden',
