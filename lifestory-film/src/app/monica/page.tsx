...
const MASS_COVERAGE = [
  ...
  {
    title: 'Sofreh Aghd + Full Ceremony',
    body: 'The entire Persian ceremony — the Sofreh Aghd, the mirror and candelabra, the blessings, the vows, and the rings.',
  ...
  {
    title: 'Persian Wedding Rituals',
    body: 'The sugar grinding, the honey ritual, and the knife dance — each tradition filmed with the reverence it deserves.',
...
export default function MonicaPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0e0c] text-[#EAE7DD]">
      ...
      <section className="pt-40 pb-24 px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-[#EAE7DD]/90 font-light leading-relaxed font-serif italic mb-8">
            Persian wedding photography and cinematography that honors every blessing, every
            promise, every tradition.
          </p>

          <p className="text-base text-[#EAE7DD]/55 font-light leading-relaxed max-w-xl mx-auto">
            November 28, 2026 &middot; Hotel Casa Del Mar, Santa Monica. California-based luxury
      ...
      <section className="py-20 px-6 bg-[#1a1916]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-[#EAE7DD]/80 font-light leading-relaxed">
            Monica — thank you so much for reaching out. We&apos;d be honored to film your wedding
            day at Hotel Casa Del Mar. To answer your question directly: yes, we film the{' '}
            <em>entire</em> Persian ceremony — the Sofreh Aghd, the mirror and candelabra, the
            sugar grinding, the honey ritual, the knife dance, the vows, the rings, and every
      ...
      {/* We film the entire Persian ceremony */}
      <section className="py-24 px-6 bg-[#0f0e0c]">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-12 text-center text-[#BFA181] font-light italic text-lg max-w-2xl mx-auto">
            Nothing is shortened or skipped — the full Persian ceremony is preserved, start to
            finish.
          </p>
        </div>
      </section>
