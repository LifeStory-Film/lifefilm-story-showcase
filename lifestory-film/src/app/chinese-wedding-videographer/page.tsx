...
const FILMS = [
  {
    title: 'Ayaka & Kyan',
    subtitle: 'Asian Fusion · Southern California',
    videoId: '17rIApee9B8',
  },
  {
...
const WHY_US = [
  {
    heading: 'Tea ceremony specialists',
    body: 'We capture every bow, every cup, every family moment of the tea ceremony — the quiet heart of a Chinese wedding, documented with the care it deserves.',
  },
  {
    heading: 'Multi-outfit coverage',
    body: 'We transition seamlessly between traditional qipao and modern bridal looks — so both sides of your day are captured with equal artistry.',
  },
  {
    heading: 'Detail photography',
    body: 'The qipao, the jewelry, the red envelopes, the decorations — every detail is documented beautifully before the day moves on.',
  },
  {
    heading: 'Bilingual-friendly team',
    body: 'We are comfortable working with multi-generational families and guests — no language or cultural barrier gets in the way of a great film.',
  },
]
...
export default function ChineseWeddingVideographer() {
  return (
    <main className="min-h-screen bg-[#0f0e0c] text-white">
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <p className="text-[#BFA181] text-[11px] tracking-widest uppercase mb-5 font-light">Chinese Weddings</p>
          <h1
            className="font-extrabold text-white leading-tight mb-6"
            style={{ fontSize: 'clamp(44px, 6vw, 72px)', letterSpacing: '-0.02em' }}
          >
            Ancient Traditions. Cinematic Stories.
          </h1>
          <p className="font-light text-white/70 max-w-[680px] mx-auto mb-10" style={{ fontSize: '18px' }}>
            We&apos;ve documented Chinese weddings across Southern California — from traditional tea ceremonies to modern receptions. Two outfits, two looks, one cohesive film.
          </p>
      ...
      <section className="py-16 bg-[#0f0e0c] border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              <div className="font-extrabold text-white mb-1" style={{ fontSize: 'clamp(32px, 4vw, 48px)', letterSpacing: '-0.02em' }}>75+</div>
              <div className="text-white/45 text-sm font-light">Chinese Weddings</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-[#0f0e0c]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          >
            "The tea ceremony is one of the most intimate moments in a Chinese wedding — two families becoming one. We treat it with the quiet reverence it deserves, and capture every cup, every bow, every tear."
          </blockquote>
      ...
      <section className="py-24 bg-[#1a1916] px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Built for Both Sides of Your Day
            </h2>
          </div>
