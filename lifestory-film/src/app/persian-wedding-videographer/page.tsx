...
const WHY_US = [
  {
    heading: 'Sofreh aghd specialists',
    body: 'We know every element of the sofreh and when each moment happens — the mirror, the candles, the herbs, the sugar cone. We are ready before you are.',
  },
  {
    heading: 'Detail-obsessed',
    body: 'The mirror, candles, herbs, eggs, coins — every element of the sofreh aghd is documented beautifully, in detail and as a whole.',
  },
  {
    heading: 'Multi-event coverage',
    body: 'From aghd ceremony to reception, we cover your entire celebration as one cohesive cinematic story — nothing treated as secondary.',
  },
  {
    heading: 'Respectful and unobtrusive',
    body: 'We blend into the ceremony without disrupting sacred moments — guests and family rarely notice us moving through the room.',
  },
]
...
export default function PersianWeddingVideographer() {
  return (
    <main className="min-h-screen bg-[#0f0e0c] text-white">
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <p className="text-[#BFA181] text-[11px] tracking-widest uppercase mb-5 font-light">Persian Weddings</p>
          <h1
            className="font-extrabold text-white leading-tight mb-6"
            style={{ fontSize: 'clamp(44px, 6vw, 72px)', letterSpacing: '-0.02em' }}
          >
            Your Sofreh. Your Story. On Film.
          </h1>
          <p className="font-light text-white/70 max-w-[680px] mx-auto mb-10" style={{ fontSize: '18px' }}>
            We&apos;ve documented Persian weddings across Southern California — from sofreh aghd ceremonies to grand receptions. We understand the traditions, the details, and what makes each moment sacred.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="text-white/45 text-sm font-light">Persian Weddings</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-[#0f0e0c]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          >
            "The sofreh aghd is one of the most beautiful ceremonial arrangements in any culture. We document it with the care and detail it deserves — every element, every symbol, every meaning."
          </blockquote>
      ...
      <section className="py-24 bg-[#1a1916] px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Built for Celebrations This Layered
            </h2>
          </div>
