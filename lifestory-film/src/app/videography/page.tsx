...
export const metadata = {
  ...
  description: "Wedding videographer in Los Angeles creating cinematic films since 2010. Same-day teasers, 4K coverage, and a team trained in narrative filmmaking. Packages from $2,499.",
