...
const WHY_US = [
  {
    ...
    body: 'We know the timeline of a Jewish wedding — from the ketubah signing to the bedeken, the chuppah, and beyond. We never miss a moment.',
  },
  {
    heading: 'The chuppah, the glass, the hora',
    body: 'Each sacred and celebratory moment is captured with cinematic precision — composed beautifully, never just documented.',
  },
  {
    heading: 'Respectful during sacred rituals',
    body: 'We are unobtrusive during religious moments and always prepared — so the rabbi, the family, and the couple never have to think about us.',
  },
  {
    heading: 'Seamless photo + film coverage',
    body: 'Our photo and video teams work in sync so nothing is missed across the full day — from quiet moments to the full energy of the dance floor.',
  },
]
...
export default function JewishWeddingVideographer() {
  return (
    <main className="min-h-screen bg-[#0f0e0c] text-white">
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <p className="text-[#BFA181] text-[11px] tracking-widest uppercase mb-5 font-light">Jewish Weddings</p>
          <h1
            className="font-extrabold text-white leading-tight mb-6"
            style={{ fontSize: 'clamp(44px, 6vw, 72px)', letterSpacing: '-0.02em' }}
          >
            Every Tradition. Every Tear. On Film.
          </h1>
          <p className="font-light text-white/70 max-w-[680px] mx-auto mb-10" style={{ fontSize: '18px' }}>
            From the ketubah signing to the hora, we capture every sacred moment and every joyful celebration of your Jewish wedding — with the reverence and artistry it deserves.
          </p>
      ...
      <section className="py-16 bg-[#0f0e0c] border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              <div className="font-extrabold text-white mb-1" style={{ fontSize: 'clamp(32px, 4vw, 48px)', letterSpacing: '-0.02em' }}>100+</div>
              <div className="text-white/45 text-sm font-light">Jewish Weddings</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-[#0f0e0c]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          >
            "A Jewish wedding moves between solemnity and pure joy unlike any other. We treat every moment — from the quiet ketubah signing to the last song of the hora — as worthy of a film."
          </blockquote>
